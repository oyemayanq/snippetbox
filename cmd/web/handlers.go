...
import (
	...
	"github.com/oyemayanq/snippetbox/internal/validator"
)
...
func (app *application) home(w http.ResponseWriter, r *http.Request) {
	...
	// Since httprouter matches path  "/" exactly no need for this check
	/*if r.URL.Path != "/" {
		app.notFound(w)
		return
	}*/
...
func (app *application) snippetView(w http.ResponseWriter, r *http.Request) {
	...
	// When httprouter parses any request, the values of named parameters will be stored
	// in request context. They can be retrieved using ParamsFromContext
	params := httprouter.ParamsFromContext(r.Context())

	// We can then use ByName to get the parameter from params
